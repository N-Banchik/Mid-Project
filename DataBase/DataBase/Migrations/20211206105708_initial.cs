    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EDIsEDI_Id = table.Column<int>(type: "int", nullable: false),
                    ItemsItem_ID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EDIItems", x => new { x.EDIsEDI_Id, x.ItemsItem_ID });
                    table.ForeignKey(
                        name: "FK_EDIItems_EDIs_EDIsEDI_Id",
                        column: x => x.EDIsEDI_Id,
                        principalTable: "EDIs",
                        principalColumn: "EDI_Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EDIItems_Items_ItemsItem_ID",
